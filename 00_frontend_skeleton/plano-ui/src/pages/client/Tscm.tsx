...
import { Building2, Shield, Radio, Layers, Eye, EyeOff } from "lucide-react";

/* ── Constants ── */
const INITIAL_CENTER: [number, number] = [14.5065, 35.9116]; // Sliema, Malta
    ...
    <div className="fixed inset-0 w-screen h-screen bg-zinc-950">
      ...
      <div className="absolute top-4 right-[340px] z-20 flex flex-col gap-2">
        <button
          ...
          title={heatmapVisible ? "Hide TSCM overlay" : "Show TSCM overlay"}
        >
          {heatmapVisible ? (
